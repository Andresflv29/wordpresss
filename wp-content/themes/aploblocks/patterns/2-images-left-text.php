<?php
 /**
  * Title: 2 images left of text
  * Slug: aploblocks/two-images-left-text
...
<div class="wp-block-columns"><!-- wp:column {"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|40"}}}} -->
...
<div class="wp-block-group aploanim fadeup  aplo-has-pull-styles"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() );?>/assets/images/27.jpg","id":2463,"dimRatio":0,"isDark":false,"aplotransforms":{"translateY":30},"hasTransforms":1,"haspullstyles":1} -->
<div class="wp-block-cover is-light aplo-has-transforms aplo-has-pull-styles" style="--aplo-transform-string:translateY(30px) "><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-2463" alt="" src="<?php echo esc_url( get_template_directory_uri() );?>/assets/images/27.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
...
<div class="wp-block-group"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() );?>/assets/images/24.jpg","id":2461,"dimRatio":0,"isDark":false} -->
<div class="wp-block-cover is-light"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-2461" alt="" src="<?php echo esc_url( get_template_directory_uri() );?>/assets/images/24.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
<p class="has-text-align-center has-large-font-size"></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group --></div>
...
<!-- wp:column {"verticalAlignment":"center","style":{"spacing":{"padding":{"top":"var:preset|spacing|30","right":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"var:preset|spacing|30"}}},"backgroundColor":"contrast","textColor":"base","aplofilters":{"dsx":3,"dsy":3,"dsb":3},"aplofiltersHover":{},"hasFilters":3} -->
...
<h2 class=""><?php echo esc_html__('Unique Builds','aploblocks') ?></h2>
<!-- /wp:heading -->

<!-- wp:heading {"level":5} -->
<h5 class=""><?php echo esc_html__('Always High quality','aploblocks') ?></h5>
<!-- /wp:heading --></div>
<!-- /wp:group -->
